...
sidebar_position: 3
---
*For 2026, this exercise is **optional**. We recommend it if you are comfortable working with DEMs or want to gain more experience in using DEMs.*
...
:::warning
This tutorial has not been updated for ArcPro or QGIS. ArcGIS 10.x has been depricated and is no longer supported by Esri. It is recommended you use ArcGIS Pro or QGIS. However, this exercise is written for ArcGIS 10.x.
:::
...
We assume you have familiarity with creating TINs and raster DEMs in ArcGIS 10.x using the 3D Analyst Extension. If not, you may find [this tutorial](http://gcd.riverscapes.xyz/Tutorials/Building_DEMs/building-dems.html) helpful.
...
:::tip
You can do this part in the stand-alone version of GCD (PC only), but you do not need ArcGIS to do the analysis. The stand-alone version is easy to use and works the same, just without map functionality. An ArcPro GCD Viewer is in development but not yet released (due spring 2026).
