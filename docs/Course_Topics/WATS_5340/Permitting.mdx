...
### Learning Outcomes
The most relevant [learning outcomes](/Syllabus/Learning_Outcomes.html#wats-5340---capstone-i) for this unit is (7), but that feeds into (1).
...
For example, the work the spring 2018 class did on [Three Mile Creek](http://capstone.restoration.usu.edu/Course_Topics/WATS_5350/Low-Tech/Projects/3mile.html), fell under this [stream alteration permit: 17-25-002](https://waterrights.utah.gov/cgi-bin/strmview.exe?Modinfo=Viewapp&Permit_Number=17250002), whreas the work that the Fall 2017 and Fall 2018 classes did on Trail Creek fell under this [stream alteration permit: 17-25-003](https://waterrights.utah.gov/cgi-bin/strmview.exe?Modinfo=Viewapp&Permit_Number=17250003). For an example from Idaho Department of Water Resources, see the 2019 class project on [Station Creek](http://capstone.restoration.usu.edu/Course_Topics/WATS_5350/Low-Tech/Projects/station.html). 
...
![Utah Public Radio](/img/upr.png)

Listen to [Utah Public Radio's Science Utah](https://www.upr.org/programs/science-utah) reporter and Watershed Science's own [Niall Clancy](https://qcnr.usu.edu/wats/people/graduates/clancy_niall) describe the Endangered Species Act in [Episode 3 of Utah Public Radio's Science Utah](https://www.upr.org/post/episode-3-endangered-species-act).
