...
### Synopsis of Topic
[![F1](/img/eg/F1.png)](https://science.sciencemag.org/content/348/6235/638/tab-pdf)
...
[![Restoration Principles - Introduction](/img/specific/2019_WATS5340_Week01.png)](https://s3-us-west-2.amazonaws.com/etalweb.joewheaton.org/Courses/WATS5340/2019/1_Restoration_Principles.pdf)

We started out with an introduction to restoration principles.

- [Restoration Principles - Introduction (PDF)](https://s3-us-west-2.amazonaws.com/etalweb.joewheaton.org/Courses/WATS5340/2019/1_Restoration_Principles.pdf) slides
- [Handout from Class (PDF)](https://s3-us-west-2.amazonaws.com/etalweb.joewheaton.org/Courses/WATS5340/2019/Day_Principles_Handout.pdf)
...
In the second week we also reviewed principles in addition to introducing the restoration [process](/Course_Topics/WATS_5340/Restoration_Process).
...
<ToolsWrapper
  cards={[
	{
	  title: 'Process-based principles for river restoration',
	  toolUrl: 'https://www.fs.fed.us/rm/pubs_other/rmrs_2010_beechie_t001.pdf',
	  imageUrl: 'http://lowtechpbr.restoration.usu.edu/img/covers/Beechie_PBR.png',
	  description: 'Beechie T, Sear DA, Olden JD, Pess GR, Buffington JM, Moir H, Roni P and Pollock MM. 2010. Bioscience. 60(3): 209-222. DOI: 10.1525/bio.2010.60.3.7'
	},
	{
	  title: 'Stream and Watershed Restoration: A Guide to Restoring Riverine Processes and Habitats',
	  toolUrl: 'https://onlinelibrary.wiley.com/doi/book/10.1002/9781118406618',
	  imageUrl: 'http://lowtechpbr.restoration.usu.edu/img/covers/RoniBeechiePBR.png',
	  description: 'Roni P and Beechie T (Eds). 2013. Wiley: Chichester, U.K., 300 pp. DOI: 10.1002/9781118406618'
	}
  ]}
  cardsize="sm"
/>
