...
const config: Config = {
    ...
    [
      'classic', // Docusaurus classic preset for docs/blog
      {
        ...
        docs: {
          ...
          editUrl: 'https://github.com/Restoration-USU/WATS-5340-5350/tree/master/docs/',
        },
  ...
  themeConfig: {
    ...
    algolia: {
      ...
      indexName: 'capstone.restoration.usu.edu',
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/Restoration-USU/WATS-5340-5350', // External GitHub link
          label: 'GitHub',
          position: 'right',
        },
      ],
      ...
      links: [
        {
          ...
          items: [
            ...
            },
            {
              ...
              href: 'https://github.com/Riverscapes/WATS-5340-5350',
            },
          ],
        },
      ],
